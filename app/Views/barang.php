                ...
                <div class="container">
                    <form action="<?= base_url(menu()['controller']); ?>/add" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input placeholder="Kode" type="text" name="kode" class="form-control form-control-sm">
                        </div>
                        ...
                        <div class="mb-3">
                            <label style="font-size: 12px;">Satuan</label>
                            <select class="form-select form-select-sm mb-3" name="satuan">
                                <?php foreach (options('Satuan') as $i): ?>
                                    <option <?= ($i['value'] == 'Pcs' ? 'selected' : ''); ?> value="<?= $i['value']; ?>"><?= $i['value']; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        ...
                        <div class="mb-3">
                            <label style="font-size: 12px;">Beli</label>
                            <input placeholder="Beli" type="text" name="beli" class="form-control form-control-sm angka" required>
                        </div>

                        <div class="mb-3">
                            <label style="font-size: 12px;">Jual</label>
                            <input placeholder="Jual" type="text" name="jual" class="form-control form-control-sm angka" required>
                        </div>
    ...
    <table class="table table-sm table-dark table-bordered" style="font-size: 14px;">
        ...
        <tbody class="tabel_search">
            <?php foreach ($data as $k => $i): ?>
                <tr>
                    <th><?= $k + 1; ?></th>
                    <td data-id="<?= $i['id']; ?>" data-col="barang" class="update_td" contenteditable="true"><?= $i['barang']; ?></td>
                    <td data-id="<?= $i['id']; ?>" data-col="qty" class="update_td" contenteditable="true"><?= angka($i['qty']); ?></td>
                    <td data-id="<?= $i['id']; ?>" data-col="beli" class="text-end update_td" contenteditable="true"><?= angka($i['beli']); ?></td>
                    <td data-id="<?= $i['id']; ?>" data-col="jual" class="text-end update_td" contenteditable="true"><?= angka($i['jual']); ?></td>
...
<script>
    ...
    $(document).on("click", ".btn_update", function(e) {
        ...
        let html = `<div class="container">
                        ...
                        <div class="mb-3">
                            <label style="font-size: 12px;">Kode</label>
                            <input placeholder="Kode" type="text" name="kode" value="${val.kode}" class="form-control form-control-sm" required>
                        </div>
        ...
        options.forEach(o => {
            html += `<option ${(o.value==val.satuan?'selected':'')} value="${o.value}">${o.value}</option>`
        });
        ...
        html += `</select>
                        ...
                        <div class="mb-3">
                            <label style="font-size: 12px;">Beli</label>
                            <input placeholder="Beli" type="text" name="beli" value="${angka(val.beli)}" class="form-control form-control-sm angka" required>
                        </div>

                        <div class="mb-3">
                            <label style="font-size: 12px;">Jual</label>
                            <input placeholder="Jual" type="text" name="jual" value="${angka(val.jual)}" class="form-control form-control-sm angka" required>
                        </div>
